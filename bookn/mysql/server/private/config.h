...
#define DEFAULT_MYSQL_HOME "/usr/local/Cellar/mariadb/10.10.2"
#define SHAREDIR "/usr/local/Cellar/mariadb/10.10.2/share/mysql"
#define DEFAULT_BASEDIR "/usr/local/Cellar/mariadb/10.10.2"
#define MYSQL_DATADIR "/usr/local/var/mysql"
#define DEFAULT_CHARSET_HOME "/usr/local/Cellar/mariadb/10.10.2"
#define PLUGINDIR "/usr/local/Cellar/mariadb/10.10.2/lib/plugin"
