...
set laststatus=2
set modelines=0
set runtimepath=~/.vim,~/.vim/plugged/vim-airline,~/.vim/plugged/vim-airline-themes,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,~/.vim/after
set showcmd
set showmatch
set tabstop=4
set undofile
...
silent only
cd ~/code/42/lastPush/mycpp/bookn
